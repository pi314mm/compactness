...
Theorem progress {e tau} :
      oft nil e tau
   -> ((forall E, (exists e', tstep E e e')) \/ is_val e).
Proof.
remember nil as G.
intro Getau.
revert HeqG.
pose (P:= (fun (G : context) e (tau : term) =>
G = nil -> (forall E : term, exists e' : term, tstep E e e') \/ is_val e
)).
...
- right. econstructor.
- right. econstructor.
- left. intros E. elim H0; eauto; intros.
...
- elim H0; eauto; intros.
  left. intros E. elim (H3 (E o (tm_pair k_hole e2))); intros. exists x. eapply tstep_pair1. eassumption.
  elim H2; eauto; intros.
  left. intros E. elim (H4 (E o (tm_pair e1 k_hole))); intros. exists x. eapply tstep_pair2. eassumption. eassumption.
...
- elim H1; eauto; intros.
  left. intros E. elim (H3 (E o (tm_pack c k_hole t))); intros. exists x. eapply tstep_pack. eassumption.
  right. econstructor. eassumption.
- left. intros E. elim H0; eauto; intros. elim (H4 (E o (tm_unpack k_hole e2))); intros.
...
- left. intros E. elim H0; eauto; intros. elim (H3 (E o (tm_lett k_hole e2))); intros.
  exists x. eapply tstep_lett1. eassumption.
  exists (E[e2.[e1]]). eapply tstep_lett2. eassumption.
- left. intros E. elim H1; eauto; intros. elim (H2 (E o (tm_abort tau0 k_hole))); intros.
  exists x. eapply tstep_abort. eassumption.
  inversion H2; subst; inversion H0.
- left. intros E. exists (E[e0.[tm_cont E]]). econstructor.
- left. intros E. elim H0; eauto; intros. elim (H3 (E o (tm_throw k_hole e2))); intros.
